...
import { dataSelect } from '../../slices/selectDataSlice';
export default function Navbar() {
    const [display, setDisplay] = useState(false);
    const [group, setGroup] = useState(localStorage.getItem('group') ? localStorage.getItem('group') : 'status');
    const [orderValue, setOrderValue] = useState(localStorage.getItem('ordervalue') ? localStorage.getItem('ordervalue') : 'title');
    ...
    useEffect(() => {
        dispatch(dataSelect(group, allTickets, allUser, orderValue));
    }, [dispatch, group, orderValue])
    return (
